...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tamisexport_tamisconnection', (
            ...
            ('description_con', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('tamis_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
    ...
    def backwards(self, orm):
        # Deleting model 'TAMISConnection'
        db.delete_table(u'tamisexport_tamisconnection')
