...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TAMISConnection.openrefine_projectnumber'
        db.alter_column(u'tamisexport_tamisconnection', 'openrefine_projectnumber', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'TAMISConnection.openrefine_projectnumber'
        db.alter_column(u'tamisexport_tamisconnection', 'openrefine_projectnumber', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        u'tamisexport.tamisconnection': {
            'Meta': {'object_name': 'TAMISConnection'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description_con': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'openrefine_projectnumber': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
